...
import { INPUT_TYPES, SIGNED_TOKEN, ToastType } from "@app/core/constants";
...
export class ResetComponent {
  ...
  ngOnInit(): void {
    this.resetToken = this.route.snapshot.params[SIGNED_TOKEN];
    ...
    this.resetForm = this.fb.group({
      ...
      confirmPassword: [
        ...
        [
          Validators.required,
          PasswordValidators.default,
          PasswordValidators.passwordsEqual(),
        ],
      ],
    });
  }
  ...
  public onReset(event: MouseEvent): void {
    ...
    this.isLoading = true;
    this.authService
      .reset({ password: this.resetForm.value.password }, this.resetToken)
